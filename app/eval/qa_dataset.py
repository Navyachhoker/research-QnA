...
QA_DATASET: List[QAItem] = [
    ...
    QAItem(
        ...
        relevant_chunk_ids=["bert__p6__c4"],
    ),
    QAItem(
        ...
        relevant_chunk_ids=["bert__p13__c7"],
    ),
    QAItem(
        ...
        relevant_chunk_ids=["bert__p13__c5"],
    ),
    QAItem(
        ...
        relevant_chunk_ids=["bert__p13__c6"],
    ),
    QAItem(
        ...
        relevant_chunk_ids=["bert__p14__c0"],
    ),
    QAItem(
    ...
    QAItem(
        ...
        relevant_chunk_ids=["bert__p15__c2"],
    ),
    QAItem(
        ...
        relevant_chunk_ids=["bert__p15__c3"],
    ),
    QAItem(
    ...
    QAItem(
        ...
        relevant_chunk_ids=["bert__p4__c7"],
    ),
    QAItem(
